...
public class Comprimit_Test {

    public Comprimit_Test() {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("########################################################");
        System.out.println("# Comprimit Test #build 1.4 - last revision: 16.11.19  #");
        System.out.println("########################################################");
        ...
        for (int i = 0; i < inputString.length; ++i){
            ...
            Comprimit comprimit = new Comprimit(path, b.length, algorisme);

            Object[] contingutIestadistiques = comprimit.descomprimir(b);
